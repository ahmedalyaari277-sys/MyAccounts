...
object MultiCurrencyReportExcelExporter {
    ...
    private fun personSheet(report: MultiCurrencyPersonReport, start: Long?, end: Long?): String {
        ...
        rows += row(n++, listOf(cell("الفترة: ${range(start, end)}", 2), cell("إصدار: ${date(System.currentTimeMillis())}", 2)))
        val header = n
        val top = mutableListOf(cell("التاريخ", 3), cell("البيان", 3)); currencies.forEach { c -> top += listOf(cell(currencyName(c), 4), cell("", 4), cell("", 4)) }
        rows += row(n++, top)
        val sub = mutableListOf(cell("", 3), cell("", 3)); currencies.forEach { sub += listOf(cell("عليه", 3), cell("له", 3), cell("الرصيد", 3)) }
        rows += row(n++, sub)
        val dates = report.reports.flatMap { it.transactions }.sortedWith(compareBy({ it.transactionDate }, { it.transactionId }))
        dates.forEach { tx ->
    ...
    private fun styles() = "<?xml version=\"1.0\" encoding=\"UTF-8\"?><styleSheet xmlns=\"http://schemas.openxmlformats.org/spreadsheetml/2006/main\"><fonts count=\"5\"><font><sz val=\"11\"/><name val=\"Arial\"/></font><font><b/><sz val=\"15\"/><name val=\"Arial\"/></font><font><sz val=\"11\"/><name val=\"Arial\"/></font><font><b/><color rgb=\"FFFFFFFF\"/><sz val=\"11\"/><name val=\"Arial\"/></font><font><b/><color rgb=\"FFFFFFFF\"/><sz val=\"12\"/><name val=\"Arial\"/></font></fonts><fills count=\"4\"><fill><patternFill patternType=\"none\"/></fill><fill><patternFill patternType=\"gray125\"/></fill><fill><patternFill patternType=\"solid\"><fgColor rgb=\"FF1565C0\"/><bgColor indexed=\"64\"/></patternFill></fill><fill><patternFill patternType=\"solid\"><fgColor rgb=\"FFF2F2F2\"/><bgColor indexed=\"64\"/></patternFill></fill></fills><borders count=\"2\"><border><left/><right/><top/><bottom/><diagonal/></border><border><left style=\"thin\"/><right style=\"thin\"/><top style=\"thin\"/><bottom style=\"thin\"/><diagonal/></border></borders><cellStyleXfs count=\"1\"><xf numFmtId=\"0\" fontId=\"0\" fillId=\"0\" borderId=\"0\" xfId=\"0\"/></cellStyleXfs><cellXfs count=\"8\"><xf numFmtId=\"0\" fontId=\"0\" fillId=\"0\" borderId=\"0\" xfId=\"0\"/><xf numFmtId=\"0\" fontId=\"1\" fillId=\"0\" borderId=\"0\" xfId=\"0\"/><xf numFmtId=\"0\" fontId=\"2\" fillId=\"0\" borderId=\"1\" xfId=\"0\"/><xf numFmtId=\"0\" fontId=\"3\" fillId=\"2\" borderId=\"1\" xfId=\"0\"/><xf numFmtId=\"0\" fontId=\"4\" fillId=\"2\" borderId=\"1\" xfId=\"0\"/><xf numFmtId=\"0\" fontId=\"4\" fillId=\"2\" borderId=\"1\" xfId=\"0\"/><xf numFmtId=\"0\" fontId=\"4\" fillId=\"2\" borderId=\"1\" xfId=\"0\"/><xf numFmtId=\"0\" fontId=\"2\" fillId=\"3\" borderId=\"1\" xfId=\"0\"/></cellXfs></styleSheet>"
}
