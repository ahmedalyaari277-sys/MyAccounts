...
class TransactionRepository(
    ...
    override fun observeArchivedTransactionsForPerson(personId: Long): Flow<List<TransactionEntity>> = transactionDao.observeArchivedTransactionsForPerson(personId)
