...
class LedgerViewModel(application: Application) : AndroidViewModel(application) {
    ...
    val personsWithAccounts: StateFlow<List<PersonWithAccounts>> = repository.allPersonsFlow
        .stateIn(
    ...
    fun addPerson(name: String, phone: String, address: String) {
        viewModelScope.launch {
            if (name.isNotBlank()) {
                repository.addPerson(name, phone, address)
            }
        }
    }
}
